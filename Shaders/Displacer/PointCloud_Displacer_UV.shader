Shader "PointCloud/Displacer/RGBA_UV"{
    ...
    SubShader{
        ...
        void disp (inout appdata_full v){
            ...
            float d = (dcolor.r*_DispChannelFactor.r + dcolor.g*_DispChannelFactor.g + dcolor.b*_DispChannelFactor.b);
		...
		void surf(Input IN, inout SurfaceOutput o){
			...
			//o.Gloss = specTex.rgb;
			o.Emission = mainTex.rgb; //o.Emission = emitTex.rgb * _EmitPower;
			//o.Alpha = alphaTex.a;
		}
