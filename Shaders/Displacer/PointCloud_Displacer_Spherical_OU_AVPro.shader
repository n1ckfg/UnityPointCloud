Shader "PointCloud/Displacer/Spherical_OU_AVPro"{
    ...
    SubShader{
        ...
        void disp (inout appdata_full v){
            v.vertex.xyz = v.normal * clamp(getDepthSpherical(tex2Dlod(_MainTex, float4(v.texcoord.xy * float2(1, 0.5) + float2(0, 0.5), 0, 0)).r), -_Maximum, 0) * _Displacement;
        }
